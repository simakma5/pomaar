...
The open challenges in front-end polarization purity, phase-centre alignment, and 2D \gls{mimo} topology synthesis identified throughout this review directly motivate the research gap formulation in \cref{chap:research-gap-analysis} and the top-down \enquote{polarimetry-first} methodology detailed in \cref{chap:feasibility-study}.
