\chapter{Research gap analysis and problem formulation}
...
Finally, \cref{sec:hypotheses} translates these combined challenges into a set of core research questions governing this doctoral work.
...
\begin{itemize}
    \item \emph{Grazing incidence:} Automotive radars operate near the ground plane (\qtyrange{0.3}{1.5}{m} mounting height), resulting in grazing incidence angles (\qtyrange[range-units=repeat]{85}{89}{\degree}).
    At these angles, pseudo-Brewster angle phenomena and rough-surface scattering dictate that vertical polarization backscatter from asphalt and concrete significantly exceeds horizontal returns.
    This surface anisotropy, demonstrated by \textcite{visentinPolarimetricRadarAutomotive2019,bouwmeesterRoadSurfaceConditions2023}, artificially inflates differential reflectivity $Z_{\mathrm{DR}}$ and biases target decomposition parameters, distorting the inferred physical scattering mechanism.
...
\begin{custombox}{Research questions}
    \begin{itemize}
        \item \textbf{Research question 1:} Can the integration of a high-resolution $12 \times 16$ \gls{mimo} architecture with Doppler-resolved polarimetric processing significantly enhance the classification accuracy of dynamic \glspl{vru}?
        \item \textbf{Research question 2:} Which polarimetric decomposition methods are most robust to the non-stationary, grazing-incidence, and multipath-dominated conditions of automotive radar, and how can they be adapted to exploit Doppler-resolved features for improved \gls{vru} classification?
        \item \textbf{Research question 3:} What are the fundamental lower bounds on antenna requirements, as derived from the sensitivity and robustness of polarimetric decomposition algorithms?
        \item \textbf{Research question 4:} How can \gls{mimo} topologies be optimized specifically for polarimetric fidelity to mitigate the detrimental effects of phase centre displacement and cross-polar coupling?
    \end{itemize}
\end{custombox}
