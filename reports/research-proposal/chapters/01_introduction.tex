...
\begin{enumerate}
    \item \textbf{Derivation of fundamental hardware bounds:} Execute perturbation analyses on decomposition algorithms to map breakdown points into minimum antenna specification bounds.
    \item \textbf{Development of a hybrid simulation platform:} Construct an electromagnetic simulation framework linking full-wave antenna patterns with ray-tracing physics and radar signal synthesis.
    \item \textbf{Synthesis of polarimetry-first MIMO topologies:} Formulate array optimization strategies that minimize phase-centre disparity and polarization squint across 2D virtual apertures.
    \item \textbf{Design of high-purity W-band front-ends:} Develop planar and integrated antenna structures at \qty{79}{\giga\hertz} with high polarization purity and port isolation.
    \item \textbf{Algorithm formulation and experimental validation:} Formulate Doppler-resolved feature extraction algorithms and validate target models through empirical measurement campaigns.
\end{enumerate}

\paragraph{Structure of the research proposal.}
...
\begin{itemize}
    \item \textbf{\Cref{chap:literature-review} (Literature review):} Synthesizes the state of the art across radar polarimetry, high-performance W-band front-end antennas, and \gls{mimo} array multiplexing schemes.
    \item \textbf{\Cref{chap:research-gap-analysis} (Research gap analysis):} Details physical domain transfer challenges, categorizes identified literature gaps, and formalizes the four central research questions governing this doctoral work.
    \item \textbf{\Cref{chap:feasibility-study} (Feasibility study):} Outlines the proposed technical methodology and presents preliminary feasibility results validating polarimetric ray tracing and W-band antenna array synthesis.
    \item \textbf{\Cref{chap:research-planning} (Research planning and doctoral education):} Establishes a four-year operational execution roadmap, mapping publishable topics to targeted venues alongside the formal doctoral education plan.
    \item \textbf{\Cref{chap:self-reflection} (Self-reflection):} Concludes the proposal with a reflection on the candidate's research progress, methodology, and doctoral development.
\end{itemize}
