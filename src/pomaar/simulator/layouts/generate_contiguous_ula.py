...
def main():
    ...
    parser.add_argument("-o", "--output", default="contiguous_ula.yaml", help="Output YAML filename (default: contiguous_ula.yaml)")
    ...
    print(f"  hfss_array_builder <project_path> <source_design_name> {output_path} --centre-freq {args.centre_freq} --bandwidth {args.bandwidth}")
