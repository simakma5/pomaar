...
def main():
    parser = argparse.ArgumentParser(description="Generate a 2D Spatial Diversity MIMO Layout JSON.")
    ...
    parser.add_argument("-o", "--output", default="spatial_diversity_2d_layout.json", help="Output JSON filename (default: spatial_diversity_2d_layout.json)")
